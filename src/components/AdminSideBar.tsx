        ...
        <>
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-40">
                    ...
                    <div className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 shadow-xl animate-slide-right">
                        <div className="p-4">
            ...
            {/* Desktop Sidebar */}
            <div className="hidden lg:flex w-64 bg-white dark:bg-gray-800 border-r dark:border-gray-700 h-screen sticky top-0 flex-col overflow-y-auto">
                <div className="p-4">
                    <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Admin Panel</h1>
                </div>
