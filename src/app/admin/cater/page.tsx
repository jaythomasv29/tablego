                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {orders.map((order) => (
                                <tr key={order.id}>
                                    <td className="px-1 py-4 whitespace-nowrap text-xs text-gray-500">
                                        {formatDate(order.createdAt)}
                                    </td>
                                    <td className="px-1 py-4 whitespace-nowrap text-xs font-medium text-gray-900">
                                        {order.name}
                                        <div>{order.email}</div>
                                        <div>{order.phone}</div>
                                    </td>
                                    ...
                                    <td className="px-1 py-4 text-xs text-gray-500">
                                        {order.message || '-'}
                                    </td>
                                </tr>
                            ))}
