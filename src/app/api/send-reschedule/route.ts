...
export async function POST(request: Request) {
    try {
        ...
        await transporter.sendMail({
            ...
            to: email,
            subject: 'Your Thaiphoon Reservation Has Been Updated',
            html: `
                <!DOCTYPE html>
                <html>
                    <head>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px; margin: 40px auto;">
                            ...
                            <tr>
                                <td style="background-color: #121212; padding: 48px 40px 40px; border-radius: 16px 16px 0 0; text-align: center;">
                                    ...
                                    <h1 style="margin: 0; color: #F9F7F2; font-family: Georgia, 'Times New Roman', serif; font-size: 32px; font-weight: normal; font-style: italic; letter-spacing: -0.01em; line-height: 1.2;">Reservation updated.</h1>
                            ...
                            <tr>
                                <td style="background-color: #ffffff; padding: 40px 40px 32px;">
                                    <p style="margin: 0 0 8px; font-family: Georgia, serif; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: #A3B18A;">Change confirmed</p>
                                    ...
                                    <p style="margin: 0 0 32px; color: #4b4b4b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; font-size: 15px; line-height: 1.7;">
                                        Your reservation has been rescheduled. Here are your updated details — we look forward to seeing you.
                                    </p>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #EAE0D5; border-radius: 12px; overflow: hidden;">
                                        <tr>
                                            <td style="padding: 20px 28px 4px;">
                                                <p style="margin: 0; font-family: Georgia, serif; font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; color: #A3B18A;">Updated Details</p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding: 18px 20px;">
                                                <p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; font-size: 13px; color: #4b4b4b; line-height: 1.6;">
                                                    Questions or further changes? Call us at <strong style="color: #121212;">(650) 323-7700</strong>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
        ...
        await transporter.sendMail({
            ...
            subject: `Rescheduled — ${name} · ${guests}p @ ${readableDate} ${time}`,
            html: `
                <!DOCTYPE html>
                <html>
                    <head>
                        <meta charset="utf-8">
                        <meta name="viewport" content="width=device-width, initial-scale=1.0">
                        <title>Reservation Rescheduled</title>
                    </head>
                    <body style="margin: 0; padding: 0; background-color: #F9F7F2; font-family: Georgia, 'Times New Roman', serif;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px; margin: 40px auto;">
                            ...
                            <tr>
                                <td style="background-color: #121212; padding: 48px 40px 40px; border-radius: 16px 16px 0 0; text-align: center;">
                                    <p style="margin: 0 0 8px; color: #A3B18A; font-family: Georgia, serif; font-size: 11px; letter-spacing: 0.18em; text-transform: uppercase;">Thaiphoon · Palo Alto</p>
                                    <h1 style="margin: 0; color: #F9F7F2; font-family: Georgia, 'Times New Roman', serif; font-size: 32px; font-weight: normal; font-style: italic; letter-spacing: -0.01em; line-height: 1.2;">Reservation rescheduled.</h1>
                                    <div style="margin: 24px auto 0; width: 48px; height: 2px; background-color: #A3B18A;"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="background-color: #ffffff; padding: 40px 40px 32px;">
                                    <p style="margin: 0 0 8px; font-family: Georgia, serif; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: #A3B18A;">Rescheduled</p>
                                    ...
                                    <p style="margin: 0 0 32px; color: #4b4b4b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; font-size: 15px; line-height: 1.7;">
                                        A guest has rescheduled their reservation. Updated details are below.
                                    </p>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 28px; border-left: 3px solid #A3B18A; background-color: #F9F7F2; border-radius: 0 8px 8px 0;">
                                        <tr>
                                            <td style="padding: 18px 20px;">
                                                <p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; font-size: 13px; color: #4b4b4b; line-height: 1.6;">
                                                    Status updated to <strong style="color: #121212;">Confirmed</strong> — the guest rescheduled via self-service.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
        ...
        return NextResponse.json(
            { success: false, error: 'Failed to send reschedule email' },
            { status: 500 }
        );
    }
}
